...
public:
	 ...
	 */
	virtual bool AreValuesEqual(const TWeakPtr<FDetailTreeNode>& TreeNodeA, const TWeakPtr<FDetailTreeNode>& TreeNodeB, TArray<FPropertySoftPath>* OutDifferingProperties = nullptr) const;
	 ...
	 * @param OutDifferingProperties optional output list of property paths for the properties that differs between the two nodes
	 */
	virtual bool AreMatching(const TWeakPtr<FDetailTreeNode>& TreeNodeA, const TWeakPtr<FDetailTreeNode>& TreeNodeB, TArray<FPropertySoftPath>* OutDifferingProperties = nullptr) const;
