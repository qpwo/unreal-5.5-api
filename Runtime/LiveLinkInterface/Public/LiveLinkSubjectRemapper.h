...
public:
	...
	LIVELINKINTERFACE_API virtual void RemapStaticData(FLiveLinkStaticDataStruct& InOutStaticData) { }

	/** Remap the frame data of a subject. */
	LIVELINKINTERFACE_API virtual void RemapFrameData(const FLiveLinkStaticDataStruct& InStaticData, FLiveLinkFrameDataStruct& InOutFrameData) { }
};
...
public:
	 ...
	 */
	LIVELINKINTERFACE_API virtual void Initialize(const FLiveLinkSubjectKey& SubjectKey) {}
