...
public:
	...
	*/
	CORE_API explicit FColorSpace(const FVector2d& InRed, const FVector2d& InGreen, const FVector2d& InBlue, const FVector2d& InWhite);
	...
	*/
	CORE_API explicit FColorSpace(UE::Color::EColorSpace ColorSpaceType);
	...
	*/
	CORE_API static TStaticArray<FVector2d, 4> MakeChromaticities(UE::Color::EColorSpace ColorSpaceType);
...
private:
	...
	CORE_API FMatrix44d CalcRgbToXYZ() const;
...
struct FColorSpaceTransform : FMatrix44d
{
	...
	*/
	CORE_API explicit FColorSpaceTransform(const FColorSpace& Src, const FColorSpace& Dst, EChromaticAdaptationMethod Method = EChromaticAdaptationMethod::Bradford);
	...
	*/
	CORE_API explicit FColorSpaceTransform(FMatrix44d Matrix);
	...
	*/
	CORE_API static FMatrix44d CalcChromaticAdaptionMatrix(FVector3d SourceXYZ, FVector3d TargetXYZ, EChromaticAdaptationMethod Method = EChromaticAdaptationMethod::Bradford);
