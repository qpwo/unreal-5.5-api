...
template <typename LhsType, bool bLhsStrength, typename RhsType, bool bRhsStrength, 
	decltype((LhsType*)nullptr == (RhsType*)nullptr) = false /* this will prevent the template instantiating if the pointer types are not comparable*/>
bool operator==(const UE::Core::Private::TPtrVariantBase<LhsType, bLhsStrength>& Lhs, const UE::Core::Private::TPtrVariantBase<RhsType, bRhsStrength>& Rhs)
{
	return Lhs.Get() == Rhs.Get();
}

template <typename LhsType, bool bLhsStrength, typename RhsType, bool bRhsStrength, decltype((LhsType*)nullptr == (RhsType*)nullptr) = false>
bool operator!=(const UE::Core::Private::TPtrVariantBase<LhsType, bLhsStrength>& Lhs, const UE::Core::Private::TPtrVariantBase<RhsType, bRhsStrength>& Rhs)
{
	return !(Lhs == Rhs);
}

template<typename LhsType, typename RhsType, bool bRhsStrength, decltype((LhsType*)nullptr == (RhsType*)nullptr) = false>
bool operator==(LhsType* Lhs, const UE::Core::Private::TPtrVariantBase<RhsType, bRhsStrength>& Rhs)
{
	return Lhs == Rhs.Get();
}
...
template<typename LhsType, bool bLhsStrength, typename RhsType, decltype((LhsType*)nullptr == (RhsType*)nullptr) = false>
bool operator==(const UE::Core::Private::TPtrVariantBase<LhsType, bLhsStrength>& Lhs, RhsType* Rhs)
{
	return Lhs.Get() == Rhs;
}
