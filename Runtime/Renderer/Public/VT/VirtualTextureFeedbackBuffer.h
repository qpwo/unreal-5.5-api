...
*/
RENDERER_API void SubmitVirtualTextureFeedbackBuffer(class FRHICommandList& RHICmdList, FBufferRHIRef const& InBuffer, FVirtualTextureFeedbackBufferDesc const& InDesc);
